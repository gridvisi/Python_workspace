'''
https://github.com/emmettgb/Emmetts-DS-NoteBooks/blob/master/Python3/Great%20Python%20modules%20for%20data%20processing.ipynb
'''
...
print(local.humanize(locale='fr'))
