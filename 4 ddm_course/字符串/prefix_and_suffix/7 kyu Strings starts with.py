...
Challenge: Given two null-terminated strings in the arguments "string" and "prefix", determine if "string" starts with the "prefix" string. Return 1 (or any other "truthy" value) if true, 0 if false.
...
def starts_with(st, prefix):
    return st.startswith(prefix)  # Notice startswith instead of startwith

st,prefix = "hello world!", "hello"
