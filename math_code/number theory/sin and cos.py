...
import math
print(math.cos(1))
if 20*(1-math.cos(x))*math.sin(x) = math.cos(x)

print((0.5*(1-math.sqrt(17))**2))
r = 6371006
print(2*(math.sqrt(1.8*1.8 + r*r-(r-1.8)**2)))
'''
import math
...
x=float(input(msg))
if not allow_zero and x#sys.float_info.epsilon 是两个浮点数比较的最小差值，这一句是判断输入是否为0
