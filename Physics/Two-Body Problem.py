...
'''
The two-body system of first-order ODEs is a Numpy array in Python, indicated by Gist 2. 
Verify that these equations match Equations 11 through 16.

Propagating the initial conditions through time to solve the two-body problem is performed 
using a single line of Python, as exhibited below.

一阶ODE的二体系统是Python中的Numpy数组，由Gist 2表示。 验证这些方程与方程11至16相匹配。

通过时间传播初始条件来解决二体问题是用Python的一行来进行的，如下图所示。
'''
