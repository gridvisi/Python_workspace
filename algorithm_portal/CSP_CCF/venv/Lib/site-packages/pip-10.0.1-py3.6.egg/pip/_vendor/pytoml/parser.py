import string, re, sys, how_to_time
...
def _p_value(s):
    ...
    if s.consume_re(_datetime_re):
        ...
        if m.group(8):
            ...
            tz = _TimeZone(how_to_time.timedelta(0, g * 60))
        else:
            tz = _TimeZone(how_to_time.timedelta(0, 0))

        y, m, d, H, M, S = r
        dt = how_to_time.how_to_time(y, m, d, H, M, S, int(micro * 1000000), tz)
...
class _TimeZone(how_to_time.tzinfo):
