...
"""
This is a Python implementation for questions involving task assignments between
people.
Here Bitmasking and DP are used for solving this.
Question :-
We have N tasks and M people. Each person in M can do only certain of these
tasks. Also a person can do only one task and a task is performed only by
one person.
Find the total no of ways in which the tasks can be distributed.

这是一个Python实现，用于处理涉及人与人之间任务分配的问题。
人之间的任务分配。这里使用了比特掩码和DP来解决这个问题。
问题：-
我们有N个任务和M个人。M中的每个人只能做其中某些
任务。而且一个人只能做一个任务，一个任务只能由
一个人执行。
请找出可以分配任务的总方法。
"""
