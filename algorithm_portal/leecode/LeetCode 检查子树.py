...
如果 T1 有这么一个节点 n，其子树与 T2 一模一样，则 T2 为 T1 的子树，也就是说，从节点 n 处把树砍断，得到的
树与 T2 完全相同。
...
class Solution:
    def checkSubTree(self, t1, t2):  # -> bool:: TreeNode : TreeNode
        if t1 == None:
            return False
        if t2 == None:
            return True
...
t1,t2 = [1, 2, 3], [2]
myTree = Solution()
print(myTree.checkSubTree(t1,t2))
